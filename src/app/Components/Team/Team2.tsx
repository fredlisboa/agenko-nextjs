...
const Team2 = () => {
    ...
    const teamContent = [
        {img:'/assets/images/digital-agency/team/vela1.webp', name:'Gabriella Liboa', content:'Harmonização Facial',instagram:'https://www.instagram.com/dragabriellalisboa/',facebook:'#',twitter:'#',linkedin:'#'},
            ...
            <div className="row">
                <div className="col-lg-12">
                    <div className="section-title text-center mb-50 pf_zoomIn">
                        ...
                        <h2>Conheça nossos resultados</h2>
                    </div>
                </div>
            </div>
                        ...
                        <Image src={item.img} alt="img" width={426} height={499}   />
                            <div className="hover-content">
                                <ul className="social-link">
                                    ...
                                    <li><a href={item.instagram} target="_blank" rel="noopener noreferrer"><i className="bi bi-instagram"></i></a></li>
                                </ul>
                            </div>
                        </div>
