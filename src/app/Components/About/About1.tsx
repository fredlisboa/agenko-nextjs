            ...
            <div className="row">
                <div className="col-xl-7">
                    ...
                    <div className="agk-content-box style-one mb-50 pf_fadeup">
                        ...
                        <p style={{textAlign: 'justify', hyphens: 'auto'}}>Acredito que a verdadeira beleza está em realçar quem você já é. Como especialista em <b>Harmonização Orofacial em Goiânia</b>, minha missão é ir além dos procedimentos: eu busco o equilíbrio perfeito entre estética e função para revelar a sua melhor versão. Vamos juntas encontrar a harmonia que seu rosto e sorriso merecem?</p>
